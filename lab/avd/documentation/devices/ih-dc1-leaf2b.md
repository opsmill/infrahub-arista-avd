...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 10.0.6.16/24 | 10.0.6.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER_dc1-server1_eth2 | *trunk | *11,19 | *4092 | *- | 1 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_ih-dc1-spine1_Ethernet4/1 | - | 10.250.3.13/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_ih-dc1-spine2_Ethernet4/1 | - | 10.250.3.15/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description SERVER_dc1-server1_eth2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet49/1
   description P2P_ih-dc1-spine1_Ethernet4/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.250.3.13/31
!
interface Ethernet50/1
   description P2P_ih-dc1-spine2_Ethernet4/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.250.3.15/31
```
...
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.250.2.6/32 |
...
!
interface Vxlan1
   description ih-dc1-leaf2b_VTEP
...
| 10.250.3.12 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.250.3.14 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 10.250.1.6:10011 | 10011:10011 | - | - | learned |
| 19 | 10.250.1.6:10019 | 10019:10019 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| VRF10 | 10.250.1.6:10 | connected | - |
...
router bgp 65104
   ...
   neighbor 10.250.3.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.250.3.12 remote-as 65100
   neighbor 10.250.3.12 description ih-dc1-spine1_Ethernet4/1
   neighbor 10.250.3.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.250.3.14 remote-as 65100
   neighbor 10.250.3.14 description ih-dc1-spine2_Ethernet4/1
